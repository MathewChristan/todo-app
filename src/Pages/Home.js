...
const Home = () => {
  ...
  }, [dispatch, navigate, userDetails.userID]);
      ...
      <div className="h-full home-main overflow-auto">
        <div className="flex justify-end mx-20 mt-10">
          <button
            ...
            className="border border-slate-800 text-slate-60 rounded-md px-3 py-2 hover:bg-slate-600 hover:text-white"
          >
            Add Task
          </button>
          <button
        ...
        {tasks &&
          (tasks.length < 1 ? (
            <div className="text-center mt-32 text-7xl text-slate-600">
              No task left !
            </div>
          ) : (
